...
const PostItem = ({ post, username, userId }) => {
  ...
  const defaultAvatar = "https://ui-avatars.com/api/?name=" + (username || post?.user?.username || "U") + "&background=random";
  const defaultImage = "https://picsum.photos/seed/" + (post?._id || "default") + "/800/500";
  ...
  return (
    <div className="post-item">
      <div className="post-item-info">
        <div className="post-item-author">
          ...
          <div className="post-author-details">
            <Link className="post-item-username" to={profileLink}>
              <span>{username ? username : post?.user?.username || "Unknown User"}</span>
            </Link>
        ...
        <i className="bi bi-three-dots" style={{ cursor: "pointer", color: "var(--text-secondary)" }}></i>
      </div>
      ...
      <div className="post-item-details-wrapper">
        <div className="post-item-actions">
          ...
          >
            ...
            <span>{liked ? (post?.likes?.length || 0) + 1 : (post?.likes?.length || 0)}</span>
          </button>
        ...
        <p className="post-item-description">
          {post?.description || "No description provided for this post. This is a fallback text that shows how the layout behaves when content is limited."}
        </p>
